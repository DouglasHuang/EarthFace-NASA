 // get reference to element containing overlay checkboxes
var overlay = document.getElementById('overlay');

// get reference to input elements in overlay container element
var faces = overlay.getElementsByTagName('input');

// assign function to onclick property of each checkbox
for (var i=0, len=faces.length; i<len; i++) {
        faces[i].onclick = function() {
        	heatmapLayer.removeData();
